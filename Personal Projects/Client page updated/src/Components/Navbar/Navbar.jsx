...
import { Close, Games, Home, LocalCafe, MenuBook, MenuBookOutlined, MenuOpenOutlined, Shop } from '@mui/icons-material';
...
<Typography sx={{ minWidth: 100, display: 'flex', alignItems: 'center' }} className='icons'>
  <span style={{ fontWeight: 'bold', fontSize: '22px', color: 'lightgray',width:'70px' }}>Home</span>
  <Home sx={{ fontSize: 40 }} className='iconColor' />
</Typography>
<Typography sx={{ minWidth: 100, display: 'flex', alignItems: 'center'}} className='icons'>
  <span style={{ fontWeight: 'bold', fontSize: '22px', color: 'lightgray' ,width:'70px'}}>Games</span>
  <Games sx={{ fontSize: 40 }} className='iconColor' />
</Typography>
<Typography sx={{ minWidth: 100, display: 'flex', alignItems: 'center', }} className='icons'>
  <span style={{ fontWeight: 'bold', fontSize: '22px', color: 'lightgray',width:'70px' }}>Cafe</span>
  <LocalCafe sx={{ fontSize: 40 }} className='iconColor' />
</Typography>
<Typography sx={{ minWidth: 100, display: 'flex', alignItems: 'center' }} className='icons'>
  <span style={{ fontWeight: 'bold', fontSize: '22px', color: 'lightgray',width:'70px' }}>Shop</span>
  <Shop sx={{ fontSize: 40 }} className='iconColor' />
</Typography>

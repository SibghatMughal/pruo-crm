...
import styles from "./CreateProfileModal28.module.css";
...
const CreateProfileModal28: FC<Props> = ({
  modalIsOpen,
  nextStep,
  prevStep,
  closeModal,
  ...
  return (
    <Modal isOpen={modalIsOpen} className={styles.modal} ariaHideApp={false}>
      <div className={styles.container}>
        <h3>
          Would you like to add frequently asked questions on your profile?
...
export default CreateProfileModal28;

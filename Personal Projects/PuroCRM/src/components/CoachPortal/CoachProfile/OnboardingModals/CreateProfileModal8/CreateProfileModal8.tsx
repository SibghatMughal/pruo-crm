...
import styles from "./CreateProfileModal8.module.css";
...
let options = [{ name: "Speaker" }, { name: "Writer" }, { name: "Poet" }];

const CreateProfileModal8: FC<Props> = ({
  modalIsOpen,
  nextStep,
  prevStep,
  closeModal,
  ...
  return (
    <Modal isOpen={modalIsOpen} className={styles.modal} ariaHideApp={false}>
      <div className={styles.container}>
        <h3>Add special credentials</h3>
        <p>
          This will allow you to be an author figure in your coaching domain
        </p>
        <p>Please select up to 3 credentials</p>
        <div
...
export default CreateProfileModal8;

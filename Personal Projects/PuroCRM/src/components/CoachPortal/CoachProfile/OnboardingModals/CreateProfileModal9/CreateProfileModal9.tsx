...
import styles from "./CreateProfileModal9.module.css";
...
let options = [{ name: "Online" }, { name: "Onsite" }, { name: "Both" }];

const CreateProfileModal9: FC<Props> = ({
  modalIsOpen,
  nextStep,
  prevStep,
  closeModal,
  ...
  return (
    <Modal isOpen={modalIsOpen} className={styles.modal} ariaHideApp={false}>
      <div className={styles.container}>
        <h3>Will you be providing sessions online, onsite or both?</h3>
...
export default CreateProfileModal9;

            ...
            >
              ...
              >
                <div className={styles.sidebarItem__left}>
                  <img src="https://purocoach-crm-assets.s3.amazonaws.com/icons/client-management.png" alt="" />
                  <h4
                    className={`${
        ...
        <div>
          <div className={styles.closeSidebar}>
            ...
            {/* <div className={styles.closedSidebarItem}>
              <img src="https://purocoach-crm-assets.s3.amazonaws.com/icons/user-management.png" alt="" />
            </div>
            ...
            >
              ...
              >
                <div className={styles.sidebarItem__left}>
                  <img src="https://purocoach-crm-assets.s3.amazonaws.com/icons/admin-workspace.png" alt="" />
                  {!showAdminWorkshpaceOptions && (
                    <div className={styles.closedArrow}>
                      <img src="https://purocoach-crm-assets.s3.amazonaws.com/icons/right-menu-arrow.png" alt="" />
                    </div>
                  )}
                </div>
              </div>
              ...
              >
                <div className={styles.closedOptionsArrow}>
                  <img src="https://purocoach-crm-assets.s3.amazonaws.com/icons/left-arrow-menu.png" alt="" />
                </div>
                ...
                <div className={styles.workspaceClosedOptions}>
                  ...
                  <ul>
                    ...
                    >
                      ...
                      >
                        <div>Payments</div>
                        <img src="https://purocoach-crm-assets.s3.amazonaws.com/icons/arrow-down.png" alt="" />
                      </div>
                    </li>
                    <ul
            ...
            {/* <div className={styles.closedSidebarItem}>
              <img src="https://purocoach-crm-assets.s3.amazonaws.com/icons/video-sessions.png" alt="" />
            </div>

            <div className={styles.closedSidebarItem}>
              <img src="https://purocoach-crm-assets.s3.amazonaws.com/icons/files-document.png" alt="" />
            </div>

...
import styles from "./CreateProfileModal11.module.css";
...
const CreateProfileModal11: FC<Props> = ({
  modalIsOpen,
  nextStep,
  prevStep,
  closeModal,
  ...
  return (
    <Modal isOpen={modalIsOpen} className={styles.modal} ariaHideApp={false}>
      <div className={styles.container}>
        <h3>
          Will you be providing payment plan for your service?{" "}
...
export default CreateProfileModal11;

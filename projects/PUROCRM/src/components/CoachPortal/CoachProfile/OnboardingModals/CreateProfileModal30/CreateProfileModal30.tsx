...
import styles from "./CreateProfileModal30.module.css";
...
const CreateProfileModal30: FC<Props> = ({
  modalIsOpen,
  nextStep,
  prevStep,
  closeModal,
  ...
  return (
    <Modal isOpen={modalIsOpen} className={styles.modal} ariaHideApp={false}>
      <div className={styles.container}>
        <h3>
          Would you like to record an introduction video along with your
          profile?
...
export default CreateProfileModal30;

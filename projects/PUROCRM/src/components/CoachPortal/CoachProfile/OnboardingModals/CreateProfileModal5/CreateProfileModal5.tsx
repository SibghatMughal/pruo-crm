...
import styles from "./CreateProfileModal5.module.css";
...
const CreateProfileModal5: FC<Props> = ({
  modalIsOpen,
  nextStep,
  prevStep,
  closeModal,
  ...
  return (
    <Modal isOpen={modalIsOpen} className={styles.modal} ariaHideApp={false}>
      <div className={styles.container}>
        <h3>Select the coaching category specialize in?</h3>
        <p>You can select up to 3 categories from below</p>
...
export default CreateProfileModal5;

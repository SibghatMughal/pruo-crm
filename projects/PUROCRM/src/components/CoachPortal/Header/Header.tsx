...
const Header: FC<Props> = ({ title }) => {
  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.headerRight__left}>
          <div className={styles.inputContainer}>
            ...
            >
              ...
              <CoachFilterMenu show={openFilters} setShow={setOpenFilters} />
            </div>
          </div>
        </div>
      ...
      <CoachMessageBar open={openMessages} setOpen={setOpenMessages} />
      <CoachInboxBar open={openMails} setOpen={setOpenMails} />
      <CoachNotificationsBar
        open={openNotifications}
        setOpen={setOpenNotifications}
      />
      <CoachFavoritesBar open={openFavorites} setOpen={setOpenFavorites} />
      <CoachProfileMenu show={openProfile} setShow={setOpenProfile} />
      <CoachThemeMenu
        show={openThemeMode}

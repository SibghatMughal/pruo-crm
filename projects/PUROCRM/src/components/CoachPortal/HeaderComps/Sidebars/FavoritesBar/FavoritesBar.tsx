...
import { CoachEmailItem } from "@/components";
          ...
          <div className={styles.favoritesItem}>
            ...
            <div className={styles.emailItemContainer}>
              ...
              <div className={styles.emailItems}>
                <CoachEmailItem
                  opened={true}
                  profileImg={`${IMAGE_URL}/notification-email-photo.jpeg`}
                  name="John Dunbar"
          ...
          <div className={styles.favoritesItem}>
            ...
            <div className={styles.linkItemContainer}>
              <div className={styles.linkItem}>
                <p>Addresss Box</p>
                <div>
                  <img src={`${IMAGE_URL}/icons/popout.png`} alt="" />
                </div>
              </div>
        ...
        <div className={styles.favoritesItem}>
          ...
          <div className={styles.linkItemContainer}>
            <div className={styles.linkItem}>
              <p>Coaching Models</p>
              <div>
                <img src={`${IMAGE_URL}/icons/documents.png`} alt="" />
              </div>
            </div>
            <div className={`${styles.linkItem} ${styles.lastItem}`}>
              <p>Google Docs</p>
